...
response_AB=$(wget -qO - "http://172.20.35.105:8000/api/v1/keys/B/enc_keys?size=512")
...
response_BA=$(wget -qO - "http://172.20.44.165:8000/api/v1/keys/A/dec_keys?key_ID=${key_id_AB}")
...
response_B=$(wget -qO - "http://172.20.44.165:8000/api/v1/keys/A/dec_keys?key_ID=628459b2-0454-49e2-a208-f1c7484e7c29")
...
response_CA=$(wget -qO - "http://172.20.34.83:8000/api/v1/keys/A/enc_keys?size=512")
...
response_AC=$(wget -qO - "http://172.20.35.105:8000/api/v1/keys/C/dec_keys?key_ID=${key_id_CA}")
...
response_BC=$(wget -qO - "http://172.20.44.165:8000/api/v1/keys/C/enc_keys?size=512")
...
echo "[*] Requesting key to C..."
response_CB=$(wget -qO - "http://172.20.34.83:8000/api/v1/keys/B/enc_keys?size=512")
